...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function pointerPrototype(this: {
      ...
      deltaX: number; deltaY: number; down: boolean; moved: boolean; color: number[];
    }) {
      this.id = -1;
      this.texcoordX = 0;
      this.texcoordY = 0;
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    class Material {
      vertexShader: any; fragmentShaderSource: string; programs: any[]; activeProgram: any; uniforms: any[];
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    function createDoubleFBO(w: number, h: number, internalFormat: number, format: number, type: number, param: number) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      let fbo1: any = createFBO(w, h, internalFormat, format, type, param);
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      let fbo2: any = createFBO(w, h, internalFormat, format, type, param);
      return {
